...
public abstract class Json
{
    ...
    //     Json tempList = map.get("things");
    //     for(int i = 0; i < tempList.size(); i++)
    //     {
    //         map.add(new Thing(tempList.get(i)));
    //     }
    // }
    ...
    public Json marshal()
    {
		...
		String filename = "thingsList.txt";

		

        for (Thing t : model.things)
        {
		...
		thingsList.save(filename);

        return map;
    }

	public Json unmarshal(Json saveMap) 
	{
